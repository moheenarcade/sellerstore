      ...
      <ul className="flex items-center gap-4 py-2 text-[#000] font-[400]">
        ...
        >
          <div className="group relative cursor-pointer">
            ...
            <div
              className={`invisible absolute z-50 bg-white shadow-2xl rounded-lg py-1 text-gray-800 group-hover:visible ${
                language === "ar" ? "w-[250px]" : "w-full"
              }`}
            >
              {categories.map((cat) => (
                <div key={cat.id} className="relative group/main-cat">
                  ...
                  {cat.sub_categories && cat.sub_categories.length > 0 && (
                    <div
                      className={`invisible absolute left-full top-0 z-50 w-56 bg-white shadow-2xl rounded-lg py-1 text-gray-800 group-hover/main-cat:visible pl-1 ${
                        language === "ar" ? "right-[96%]" : "right-0"
                      }`}
                    >
