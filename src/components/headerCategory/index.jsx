                ...
                >
                    <div className="group relative cursor-pointer">
                        <div className="flex items-center justify-between space-x-5 bg-white">
                            <a
                                className="menu-hover group-hover:text-[#f69853] flex items-center gap-1 text-base font-[400] text-black lg:mx-4"
                            >
                        ...
                        <div className={`invisible absolute z-50 bg-white shadow-2xl rounded-lg py-1 text-gray-800 group-hover:visible ${language === 'ar' ? 'w-[250px]' : 'w-full'}`}>
                            {categories.map((cat) => (
