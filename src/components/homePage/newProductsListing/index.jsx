...
const NewProductsListing = () => {
    ...
    return (
        <div className='new-product-main container px-2 md:px-6 xl:px-28 mx-auto pt-6 md:pt-12'>
            <div className="flex justify-between items-center">
                <h2 className='text-xl md:text-2xl font-[600] text-[#000000de]'>{t('new_products')}</h2>
            ...
            <div className="product-lists pt-6">
                {products.map((productList, index) => (
                    <div key={index} className="product-card-main group border-[1px] border-[#0000001f] rounded-md cursor-pointer p-4 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 ease-in-out">
                        <div className="">
                            <div className="product-banner-sec relative overflow-hidden">
                                {/* <Image className='w-full block' src={HotsSlide1} alt='product banner' />
                                <Image
