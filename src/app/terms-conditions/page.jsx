    ...
    return (
        <div className='terms-condition-main container px-4 md:px-6 xl:px-28 mx-auto'>
            <div class="max-w-4xl mx-auto px-4 py-12">
                <h1 class="text-2xl xl:text-4xl font-bold mb-12 text-center">Terms & Conditions</h1>
                <section class="mb-10">
                ...
                <section class="mb-10">
                    <h2 class="text-lg xl:text-2xl font-semibold mb-2">2. Eligibility</h2>
                    <p class="text-gray-700">
                ...
                <section class="mb-10">
                    <h2 class="text-lg xl:text-2xl font-semibold mb-2">3. Orders & Payments</h2>
                ...
                <section class="mb-10">
                    <h2 class="text-lg xl:text-2xl font-semibold mb-2">4. Shipping & Delivery</h2>
                    <p class="text-gray-700">
                ...
                <section class="mb-10">
                    <h2 class="text-lg xl:text-2xl font-semibold mb-2">5. Returns & Refunds</h2>
                    <p class="text-gray-700">
                ...
                <section class="mb-10">
                    <h2 class="text-lg xl:text-2xl font-semibold mb-2">6. User Conduct</h2>
                    <p class="text-gray-700">
                ...
                <section class="mb-10">
                    <h2 class="text-lg xl:text-2xl font-semibold mb-2">7. Intellectual Property</h2>
                    <p class="text-gray-700">
                ...
                <section class="mb-10">
                    <h2 class="text-lg xl:text-2xl font-semibold mb-2">8. Limitation of Liability</h2>
                    <p class="text-gray-700">
                ...
                <section class="mb-10">
                    <h2 class="text-lg xl:text-2xl font-semibold mb-2">9. Governing Law</h2>
                    <p class="text-gray-700">
